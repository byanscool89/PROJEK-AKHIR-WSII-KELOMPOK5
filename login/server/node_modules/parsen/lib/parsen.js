...
var batch, checkForKeys, objects, request, users,
  _this = this;
...
checkForKeys = function() {
  if (!(_this.parseApplicationId && _this.parseRESTAPIKey)) {
    throw new Error('Woah, slow down there. Set your keys before getting all Parse-happy!');
  }
};

module.exports.parseApplicationId = this.parseApplicationId;

module.exports.parseRESTAPIKey = this.parseRESTAPIKey;
